...
if(sessionStorage.getItem("Info")){
    ...
    teatchersArray = data.teatchersId;
}else{
...
function tableTitle(){
    ...
    case 0 :
        ...
        break;
    case 1 :
        weektitle.innerHTML = ` الأسبوع الثاني - شهر ${monthtitle}`
        break;
    case 2 :
        weektitle.innerHTML = ` الأسبوع الثالث - شهر ${monthtitle}`
        break;
    case 3 :
        weektitle.innerHTML = ` الأسبوع الرابع - شهر ${monthtitle}`
        break;
    case 4 :
        weektitle.innerHTML = ` الأيام الأخيرة - شهر ${monthtitle}`
        break;
}
}
tableTitle()
                    ...
                    res=>{
                        ...
                        weekArray.map(element=>{
                            ...
                            let check = day.daily.some(obj=>{
                              return Object.keys(obj).join("") == sessionStorage.getItem("User")
                            })
                           if(check){
                            day.daily.map(ele=>{
                                if(Object.keys(ele) == sessionStorage.getItem("User") && addedStudint == false){
                            ...
                            function fillCells(data ,id ,day){
                                ...
                                case "الأحد":
                                    day.daily.map(e=>{
                                        if(Object.keys(e).join("") == sessionStorage.getItem("User")){
